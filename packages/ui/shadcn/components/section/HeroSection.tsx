...
const HeroSection = ({ id }: { id?: string }) => {
  return (
    <SectionWrapper id={id} className="py-20" contentClassName="text-center space-y-8">
      <React.Fragment>
        <h1 data-section-heading className="text-4xl font-bold">
          Your Awesome Product
        </h1>
        <p data-section-body className="text-lg text-muted-foreground">
